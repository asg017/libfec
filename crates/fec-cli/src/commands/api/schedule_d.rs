use crate::cli::ApiScheduleDArgs;
...
pub fn build_url(args: &ApiScheduleDArgs) -> Url {
    ...
    client
        .endpoint_url("/v1/schedules/schedule_d/", &param_refs)
        .0
}

pub fn schedule_d(mut sourcer: FilingSourcer, args: &ApiScheduleDArgs) -> anyhow::Result<()> {
