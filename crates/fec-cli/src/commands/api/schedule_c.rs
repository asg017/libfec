use crate::cli::ApiScheduleCArgs;
use crate::sourcer::FilingSourcer;
use fec_api::Api;
use url::Url;

use super::shared::{fetch_and_output, print_url, push_opt, push_opt_f64, push_vec};

pub fn build_url(args: &ApiScheduleCArgs) -> Url {
    ...
    push_vec(&mut params, "loan_source_name", &args.loan_source_name);
    ...
    client
        .endpoint_url("/v1/schedules/schedule_c/", &param_refs)
        .0
}

pub fn schedule_c(mut sourcer: FilingSourcer, args: &ApiScheduleCArgs) -> anyhow::Result<()> {
